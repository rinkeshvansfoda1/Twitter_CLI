...
# te='https://twitter.com/search?q='+acc+'&src=typed_query&f=user'
# print(te)
...
headers = {
    ...
    'referer': 'https://twitter.com/search?q='+f'{acc}'+'&src=typed_query&f=user',
...
with open('C:\\Users\\KPRRS\\name.json',encoding='utf-8') as source_json:
    read_context=json.load(source_json)

# print(read_context)

objj=read_context['globalObjects']['users']
for i in objj:
    print("Account Name:",objj[i]['name'])
    print("Account Id:",objj[i]['screen_name'])
    # print("User ID:",objj[i]['id_str'])
    print("Account Description:",objj[i]['description'])
    print()