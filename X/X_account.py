...
variables=f'{{"screen_name":"{acc}","withSafetyModeUserFields":true}}'
...
file=open('account_data.json','w',encoding='utf-8')
file.write(str(soup))
file.close()
...
with open('account_data.json',encoding='utf-8') as source_json:
