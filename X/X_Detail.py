...
cookies = {
    ...
    'lang': 'en',
    'personalization_id': '"v1_G29MKx/vpmMBYnnfHvuO6Q=="',
}
...
headers = {
    ...
    'x-client-transaction-id': 'aUXm83pwxnCKiPFknAPZwnCX4VgVHAih9CYBsy+90kI4H5ptfzyWNp2oR7RNtR28YkeEqGlPrC9BOYvfFXt+ZMWRs7HoaA',
...
variables=f'{{"userId":"{acc_id}","count":"{sas}","includePromotedContent":true,"withQuickPromoteEligibilityTweetFields":true,"withVoice":true,"withV2Timeline":true}}'

params = {
    'variables': '{"userId":"135421739","count":20,"includePromotedContent":true,"withQuickPromoteEligibilityTweetFields":true,"withVoice":true,"withV2Timeline":true}',
...
response = requests.get(
    'https://twitter.com/i/api/graphql/S1oSH7OJKAdzafiVzZqz1Q/UserTweets',
    params=params,
    cookies=cookies,
    headers=headers,
)
...
# to read json file
import json
with open('info.json',encoding='utf-8') as source_json:
    read_context=json.load(source_json)
